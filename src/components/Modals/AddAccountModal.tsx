        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                accept=".tdata,.session"
                disabled={loading}
              />
            </div>
            <p className="mt-1 text-xs text-gray-400">
              Upload your Telegram session file (TData format)
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., work_account"
              disabled={loading}
            />
            {errors.sessionName && (
              <p className="mt-1 text-sm text-red-400">{errors.sessionName.message}</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              {...register('accountName', { required: 'Display name is required' })}
              type="text"
              className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
